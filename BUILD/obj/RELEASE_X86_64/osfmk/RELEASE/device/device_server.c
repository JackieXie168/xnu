/*
 * IDENTIFICATION:
 * stub generated Thu Nov 27 20:35:39 2014
...
#endif
	typedef __Request__io_connect_map_memory_into_task_t __Request;
	typedef __Reply__io_connect_map_memory_into_task_t Reply;
...
#endif
	typedef __Request__io_connect_unmap_memory_from_task_t __Request;
	typedef __Reply__io_connect_unmap_memory_from_task_t Reply;
...
#endif
	typedef __Request__io_connect_method_t __Request;
	typedef __Reply__io_connect_method_t Reply;
...
#endif
	typedef __Request__io_connect_async_method_t __Request;
	typedef __Reply__io_connect_async_method_t Reply;
...
#endif
	typedef __Request__io_connect_set_notification_port_64_t __Request;
	typedef __Reply__io_connect_set_notification_port_64_t Reply;
...
#endif
	typedef __Request__io_service_add_notification_64_t __Request;
	typedef __Reply__io_service_add_notification_64_t Reply;
...
#endif
	typedef __Request__io_service_add_interest_notification_64_t __Request;
	typedef __Reply__io_service_add_interest_notification_64_t Reply;
...
#pragma pack()
#endif
	typedef __Request__io_service_add_notification_ool_64_t __Request;
	typedef __Reply__io_service_add_notification_ool_64_t Reply;
	...
	RetCode = is_io_service_add_notification_ool_64(In0P->Head.msgh_request_port, In0P->notification_type, (io_buf_ptr_t)(In0P->matching.address), In1P->matchingCnt, In0P->wake_port.name, In1P->reference, In1P->referenceCnt, &OutP->result, &notification);
	if (RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, RetCode);
	}
#if	__MigKernelSpecificCode
...
#endif
	typedef __Request__io_registry_entry_get_registry_entry_id_t __Request;
	typedef __Reply__io_registry_entry_get_registry_entry_id_t Reply;
...
#endif
	typedef __Request__io_connect_method_var_output_t __Request;
	typedef __Reply__io_connect_method_var_output_t Reply;
...
#endif
	typedef __Request__io_service_get_matching_service_t __Request;
	typedef __Reply__io_service_get_matching_service_t Reply;
...
#pragma pack()
#endif
	typedef __Request__io_service_get_matching_service_ool_t __Request;
	typedef __Reply__io_service_get_matching_service_ool_t Reply;
	...
	RetCode = is_io_service_get_matching_service_ool(In0P->Head.msgh_request_port, (io_buf_ptr_t)(In0P->matching.address), In0P->matchingCnt, &OutP->result, &service);
	if (RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, RetCode);
	}
#if	__MigKernelSpecificCode
	...
	(mach_msg_header_t *InHeadP, mach_msg_header_t *OutHeadP)
{
	...
	if ((InHeadP->msgh_id > 2874) || (InHeadP->msgh_id < 2800) ||
