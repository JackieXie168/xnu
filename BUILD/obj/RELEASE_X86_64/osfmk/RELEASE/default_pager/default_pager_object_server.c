...
const struct default_pager_object_subsystem default_pager_object_subsystem = {
	...
	(vm_address_t)0,
	{
          ...
          (mig_stub_routine_t) _Xdefault_pager_object_create, 4, 0, (routine_arg_descriptor_t)0, (mach_msg_size_t)sizeof(__Reply__default_pager_object_create_t)},
          { (mig_impl_routine_t) 0,
		...
		{0, 0, 0, 0, 0, 0},
          ...
          { (mig_impl_routine_t) 0,
          (mig_stub_routine_t) _Xdefault_pager_add_file, 5, 0, (routine_arg_descriptor_t)0, (mach_msg_size_t)sizeof(__Reply__default_pager_add_file_t)},
          { (mig_impl_routine_t) 0,
