...
# build inside the Xcode derived-files directory
cd $DERIVED_FILE_DIR
...
MIG_HEADER_DST="$XNU_INSTALL_BASE/usr/include/mach"
MIG_PRIVATE_HEADER_DST="$XNU_INSTALL_BASE/usr/local/include/mach"
SERVER_HEADER_DST="$XNU_INSTALL_BASE/usr/include/servers"
MACH_HEADER_DST="$XNU_INSTALL_BASE/usr/include/mach"
...
SRC="$SRCROOT/libsyscall/mach"
MIG_INTERNAL_HEADER_DST="$DERIVED_SOURCES_DIR/mach"
MIG_PRIVATE_DEFS_INCFLAGS="-I${XNU_INSTALL_BASE}/System/Library/Frameworks/System.framework/PrivateHeaders"
